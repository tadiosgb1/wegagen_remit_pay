...
class UrlContainer {
  ...
  static String getExchangeRate(String from, String to) => '$baseUrl/exchange-rates/$from/$to';
  ...
  static String validateBankAccount(String bankCode) => '$baseUrl/banks/$bankCode/validate';
}