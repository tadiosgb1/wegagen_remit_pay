    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: AppColors.primary, // Explicitly orange
          foregroundColor: Colors.white,
          ...
          elevation: 2,
          // Override any theme color that might interfere
        ).copyWith(
          backgroundColor: WidgetStateProperty.all(AppColors.primary), // Force orange
        ),
        child: const Text(
          'Continue to Payment',
