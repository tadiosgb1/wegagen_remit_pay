  ...
  Future<Map<String, dynamic>> collectDeviceDataForDDC() async {
    try {
      ...
      return {
        ...
        'browserUserAgent':
            'Mozilla/5.0 (Linux; Android 10; Mobile) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36 RoohaRemitApp/1.0.0',
        'browserAcceptHeader':
      ...
      return {
        ...
        'browserUserAgent':
            'Mozilla/5.0 (Linux; Android 10; Mobile) AppleWebKit/537.36 RoohaRemitApp/1.0.0',
        'browserLanguage': 'en-US',
        'browserAcceptHeader':
