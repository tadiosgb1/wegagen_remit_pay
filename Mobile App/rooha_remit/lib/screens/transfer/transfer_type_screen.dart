...
class _TransferTypeScreenState extends State<TransferTypeScreen> {
  ...
  String get _transferDescription {
    switch (widget.transferType) {
      ...
      case 'rooha_ebirr':
        return 'Send money to Rooha E-birr mobile wallets';
      case 'cash_pickup':
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              Text(exchangeProvider.error!, textAlign: TextAlign.center),
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Rate: ${currency['buyingRate']?.toStringAsFixed(2) ?? currency['rate'].toStringAsFixed(2)} ETB',
                                  style: const TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
