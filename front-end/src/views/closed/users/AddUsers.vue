    ...
    <div class="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md overflow-hidden animate-pop-in border border-slate-100">
      ...
      <div class="p-8">
        <div class="flex justify-between items-start mb-6">
          <div>
            <h2 class="text-2xl font-black text-slate-900 leading-none">Add User</h2>
            <p class="text-[10px] font-black uppercase tracking-[0.2em] text-primary mt-2 flex items-center gap-2">
              <i class="fas fa-user-plus"></i> Create Directory Entry
            </p>
          </div>
          ...
          <div class="flex gap-3 pt-2">
            ...
            <button type="submit" :disabled="loading"
              ...
              <template v-if="!loading">
                Register User <i class="fas fa-arrow-right text-[8px] group-hover:translate-x-1 transition-transform"></i>
              </template>
              <template v-else>
